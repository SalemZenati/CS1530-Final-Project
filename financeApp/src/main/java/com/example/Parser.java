    ...
    public static List<User> readDataFromFile(String filename) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            for (int i = 0; i < numUsers; i++) {
                ...
                temp = scanner.nextLine();
                int numPlans = Integer.parseInt(scanner.nextLine().substring(9,temp.length()));
                temp = scanner.nextLine();
                int numBudgets = Integer.parseInt(scanner.nextLine().substring(11,temp.length()));
                ...
                for (int j = 0; j < numAccounts; j++) {
                    ...
                    int acid = Integer.parseInt(scanner.nextLine().substring(5,6));
                    temp = scanner.nextLine();
